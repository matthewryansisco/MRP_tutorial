"This script generates frequency tables, i.e. all possible combinations of the
...
sum(freq_table_state$count)#should be equal to the number of rows in ACS
head(freq_table_state)

#Create a proportion column
#This represents our estimate of the proportion of people
#with each demographic combination in the target population.
freq_table_state$proportion <- freq_table_state$count / 
